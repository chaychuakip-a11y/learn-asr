"""Build the FSDD speaker-generalization intensive notebook."""
...
OUT = ROOT / "notebooks" / "专题_FSDD说话人泛化实验_数据划分增强与盲测.ipynb"
...
for cell_index, cell in enumerate(cells):
    # nbformat otherwise assigns random IDs, producing a 35-cell diff on every build.
    cell["id"] = f"fsdd-{cell_index:02d}"
