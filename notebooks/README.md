...
| `认知拓展_01_...ipynb` ～ `认知拓展_08_...ipynb` | 论证、概率、因果、系统、决策、信息、预测与学习科学 |
| `研究进阶_01_...ipynb` ～ `研究进阶_08_...ipynb` | 条件、量词、溯因、论证图、检索、溯源、证据综合与开放科学 |
...
- 6 节音频零基础桥梁课；
- 6 节研究与工程思维课；
- 8 节跨领域认知拓展课与 1 份认知工具箱总手册；
- 8 节逻辑与信息研究进阶课、研究总手册与可审计工作台；
...
→ 认知拓展 01～08（跨领域选修，可与 ASR 主线交错）
→ 研究进阶 01～08（逻辑与信息搜集进阶，以真实研究档案验收）
...
| 认知拓展工具箱 | 认知拓展 01～08 | 论证、贝叶斯、因果图、系统反馈、决策、信息论、预测校准、学习科学 |
| 逻辑与信息研究进阶 | 研究进阶 01～08 | 问题树、必要/充分、量词、溯因、论证图、布尔检索、横向阅读、来源家族、证据矩阵、开放科学 |
